...
func (r *router) configureRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /posts/{publicId}", r.post.getPost)
	mux.HandleFunc("DELETE /posts/{publicId}", r.post.deletePost)
	mux.HandleFunc("POST /posts/{publicId}/likes", r.post.likePost)
	mux.HandleFunc("DELETE /posts/{publicId}/likes", r.post.unlikePost)
	mux.HandleFunc("POST /posts/{publicId}/reposts", r.post.repostPost)
	mux.HandleFunc("DELETE /posts/{publicId}/reposts", r.post.removeRepost)
	mux.HandleFunc("GET /posts/{publicId}/replies", r.post.getReplies)
	...
	mux.HandleFunc("DELETE /search/recent", r.search.clearRecentSearches)
