...
- Hash passwords with the established password-hashing primitive and verify
  them in constant time. Never log passwords, password hashes, or reset-like
  credentials.
- Normalize and validate usernames, email addresses, names, bios, and image
  keys before persistence. Preserve uniqueness guarantees in PostgreSQL.
