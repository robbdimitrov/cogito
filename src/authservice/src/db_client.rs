...
impl DbClient {
    ...
    pub async fn get_user(&self, email: &str) -> Result<Option<(i32, String)>, sqlx::Error> {
    ...
    pub async fn get_session(&self, session_id: &str) -> Result<Option<crate::thoughts::Session>, sqlx::Error> {
    ...
    pub async fn get_sessions(&self, user_id: i32) -> Result<Vec<crate::thoughts::Session>, sqlx::Error> {
        self.delete_expired_sessions().await?;
        let ttl = session_ttl_days();
